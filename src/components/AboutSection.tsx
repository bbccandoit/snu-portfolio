        ...
        <div className="grid items-start gap-12 lg:grid-cols-2 lg:gap-20">
          <div className="relative mx-auto w-full max-w-lg lg:mx-0">
            <div className="grid grid-cols-2 gap-4">
              <div className="aspect-[3/4] bg-gradient-to-br from-stone-300 to-stone-500" />
              <div className="mt-12 aspect-square bg-gradient-to-br from-neutral-400 to-neutral-600" />
              <div className="col-span-2 aspect-[16/9] bg-gradient-to-br from-zinc-400 to-zinc-600" />
            </div>
          </div>
